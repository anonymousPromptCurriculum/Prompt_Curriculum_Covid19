...
prefix_pattern = {'2':['To what extent does the message appear to contain false information? ','. '],
...
answer = {'2':['no', 'yes'],'3':['no', 'yes'],'4':['no', 'yes'],'5':['no', 'yes'],'6':['no', 'yes'],'7':['no', 'yes']}
position = {}
appendix_pattern = {1:['']}
...
def main(model_name, qid, epoch):
    ...
    text, label = lct.data_process(data_file, qid)
...
if __name__ == '__main__':
    ...
    main(args.type, args.qid, int(args.ep))
